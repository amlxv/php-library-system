...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="main_navbar">
                <ul class="navbar-nav mb-1 mt-1 mb-lg-1">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-nav btn-primary" href="../borrower">Borrower</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="my-3 d-flex flex-row justify-content-between">
            <h2>Borrower</h2>
            <h2><a class="btn btn-success" data-bs-target="#addBorrower_modal" data-bs-toggle="modal"><i
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td> " . $row['name'] . " </td>
                    <td> " . $row['phone_num'] . " </td>
                    <td><a class='btn btn-outline-primary details' data-bs-toggle='modal' data-bs-target='#detailsBorrower_modal' data-user-id='" . $row['id'] . "'>Details</a></td>
                    <td>    
                        <div class='text-nowrap'>
                            <a class='btn btn-primary update' data-bs-toggle='modal' data-bs-target='#updateBorrower_modal' data-user-id='" . $row['id'] . "' ><i class='fas fa-edit'></i></a>
                            <a class='btn btn-danger delete' data-id='detailsBorrower' data-user-id='" . $row['id'] . "' data-user-name='" . $row['name'] . "' ><i class='fas fa-trash-alt'></i></a>
                        </div>
                    </td>
                </tr>
                ";
    ...
    <!-- Start :: Add Borrower Modal -->
    <div class="modal fade" id="addBorrower_modal" tabindex="-1" aria-labelledby="addBorrower_modalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addBorrower_modalLabel">Add New Borrower</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addBorrower" action="../App/Borrower/Borrower.php" method="post">
                        <input type="hidden" name="type" value="add">
                        <div class="mb-2">
                            <label class="form-label" for="add_id">Borrower ID</label>
                            <input class="form-control" type="text" name="id" id="add_id" placeholder="Borrower's ID"
                                required>
                        </div>
                        <div class="mb-2">
                            <label class="form-label" for="add_name">Name</label>
                            <input class="form-control" type="text" name="name" id="add_name"
                                placeholder="Borrower's Name" required>
                        </div>
                        <div class="mb-2">
                            ...
                            <input class="form-control" type="text" name="phone_num" id="add_phone_num"
                                placeholder="Borrower's Phone Number" required>
                        </div>
                        <div class="mb-2">
                            ...
                            <input class="form-control" type="password" name="password" id="add_password"
                                placeholder="Borrower's Password" required>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mt-4">
                            <input type="submit" class="btn btn-success float-end ms-2" value="Add New Borrower">
    ...
    <!-- Start :: Update Borrower Modal -->
    <div class="modal fade" id="updateBorrower_modal" tabindex="-1" aria-labelledby="updateBorrower_modalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateBorrower_modalLabel">Update Borrower Information</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="updateBorrower" action="../App/Borrower/Borrower.php" method="post">
                        <input type="hidden" name="type" value="update">
                        <div class="">
                            <label class="form-label" for="update_id">Borrower ID</label>
                            <input class="form-control" type="text" name="id" id="update_id" placeholder="Borrower's ID"
                                readonly>
                            <p class="text-muted">Borrower ID can't be changed.
                            </p>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input class="form-control" type="password" name="password" id="update_password"
                                placeholder="Borrower's Password">
                        ...
                        <div class="mt-4">
                            <input type="submit" class="btn btn-success float-end ms-2" value="Update Borrower">
                            <button type="button" class="btn btn-danger float-end"
                                data-bs-dismiss="modal">Cancel</button>
                        </div>
                    </form>
    ...
    <!-- End :: Update Borrower Modal -->

    <!-- Start :: Details Borrower Modal -->
    <div class="modal fade" id="detailsBorrower_modal" tabindex="-1" aria-labelledby="detailsBorrower_modalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailsBorrower_modalLabel">Borrower Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="detailsBorrower" action="../App/Borrower/Borrower.php" method="post">
                        <div class="mb-2">
                            <label class="form-label" for="details_id">Borrower ID</label>
                            <input class="form-control" type="text" name="id" id="details_id"
                                placeholder="Borrower's ID" readonly>
                        </div>
                        <div class="mb-2">
                            <label class="form-label" for="details_name">Name</label>
                            <input class="form-control" type="text" name="name" id="details_name"
                                placeholder="Borrower's Name" readonly>
                        </div>
                        <div class="mb-2">
                            ...
                            <input class="form-control" type="text" name="phone_num" id="details_phone_num"
                                placeholder="Borrower's Phone Number" readonly>
                        </div>
